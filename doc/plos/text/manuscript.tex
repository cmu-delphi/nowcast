...
\begin{description}
  ...
  \item{\textbf{Google Health Trends}} \\
...
%the popularity of selected articles to estimate wILI for the US as a whole.
%
%As with WIKI, we use popularity of selected pages to estimate ILI within US
%states.
%
%Inputs available at sub-weekly temporal resolution are aggregated to form
%weekly readings.
