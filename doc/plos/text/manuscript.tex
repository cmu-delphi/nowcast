...
\subsection*{Accuracy relative to data sources}

The error (measured in MAE and RMSE) of nowcasts of ILI for the US as a whole
relative to the same error for each data source are shown in
Fig~\ref{figure_accuracy_vs_sensors}.
...
\subsection*{Accuracy relative to baselines}

TODO (python3 analyze.py metrics)
