...
% Don't include figures in the final version. This is just for preview.
\newgeometry{top=1.0in,left=1.0in,footskip=30pt}
\begin{figure}[p]
  \includegraphics[width=\textwidth]{../data/figures/sensor_heatmap_top.png}
  Figure 1 (top).
\end{figure}
\begin{figure}[p]
  \includegraphics[width=\textwidth]{../data/figures/sensor_heatmap_bottom.png}
  Figure 1 (bottom).
\end{figure}
\begin{figure}[p]
  \includegraphics[width=\textwidth]{../data/figures/all_nowcasts.png}
  Figure 2.
\end{figure}
\begin{figure}[p]
  \includegraphics[width=\textwidth]{../data/figures/accuracy_vs_sensors.png}
  Figure 3.
\end{figure}
\begin{figure}[p]
  \includegraphics[width=\textwidth]{../data/figures/accuracy_vs_ablation.png}
  Figure 4.
\end{figure}
\begin{figure}[p]
  \includegraphics[width=\textwidth]{../data/figures/accuracy_vs_abscission.png}
  Figure 5.
\end{figure}
