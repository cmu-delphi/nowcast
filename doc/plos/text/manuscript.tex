...
these sources with wILI may be nonlinear) or overfitting (e.g. covariance may
be underestimated for these sources).

\subsubsection*{Sensitivity to geographic resolution}

TODO(abscission experiments)
...
TODO(curse of dimensionality and regularization)

TODO(ablation: overfitting, assumptions, time-variable relationships)
